...
import { AlertCircle, CheckCircle2, Clock, TrendingUp, Users, FileText, BarChart3, LogOut } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const topReporters = mockUsers.slice(0, 5).sort((a, b) => b.reportCount - a.reportCount);
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-neutral-400">Manage reports, users, and system analytics</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {stats.map((stat) => {
            ...
            return (
              <div key={stat.label} className="relative overflow-hidden rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 p-6 border border-neutral-700 hover:border-neutral-600 transition-colors">
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-white font-medium group-hover:text-cyan-400 transition-colors">{report.title}</p>
              ...
              <div className="rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 p-6">
                ...
                <div className="space-y-4">
                  {topReporters.map((user, index) => (
                    <div key={user.id} className="flex items-center gap-3 p-3 rounded-lg bg-neutral-900/50 border border-neutral-700/50">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-neutral-500">{user.reportCount} reports</p>
                      </div>
                      <div className="text-cyan-400 font-bold text-sm">{user.points}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-neutral-700">
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Title</th>
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Location</th>
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Category</th>
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Level</th>
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Status</th>
                    <th className="text-left py-4 px-4 text-neutral-400 font-medium">Date</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredReports.map((report) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-neutral-400 text-sm">{report.location}</td>
                ...
                >
                  ...
                  <div className="flex items-center gap-8 text-right">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-cyan-400">{user.level}</p>
                    </div>
                    <div>
